...
const pl = {
  ...
  'loading.title': 'Łączymy się ze Smithsonian',
  'loading.body': 'Pobieramy katalog wulkanów, historię erupcji i najnowszy raport tygodniowy.',
  ...
  'filters.sourceNote': 'Dane wulkanologiczne: Smithsonian GVP. Podkład satelitarny: EOxCloudless / Copernicus Sentinel-2. Dane aplikacji pozostają wyłącznie w pamięci.',
...
const en: Record<TranslationKey, string> = {
  ...
  'loading.title': 'Connecting to Smithsonian',
  'loading.body': 'Fetching the volcano catalog, eruption history, and the latest weekly report.',
  ...
  'filters.sourceNote': 'Volcanological data: Smithsonian GVP. Satellite basemap: EOxCloudless / Copernicus Sentinel-2. Application data remains only in memory.',
