...
const pl = {
  ...
  'reports.close': 'Zamknij biuletyn i wróć do mapy',
...
const en: Record<TranslationKey, string> = {
  ...
  'reports.aria': 'Latest weekly reports', 'reports.bulletin': 'CURRENT BULLETIN', 'reports.close': 'Close bulletin and return to map', 'reports.title': 'Weekly activity', 'reports.updated': 'Updated {date}',
